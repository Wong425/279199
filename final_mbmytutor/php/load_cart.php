...
FROM tbl_carts INNER JOIN tbl_subjects ON tbl_carts.course_id = tbl_subjects.subject_id WHERE tbl_carts.email = '$email' AND tbl_carts.cart_status IS NULL";
...
if ($result->num_rows > 0) {
    ...
    while ($rows = $result->fetch_assoc()) {
        ...
        $crlist['cricetotal'] = number_format((float)$price, 2, '.', ''); 
